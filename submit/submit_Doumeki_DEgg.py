...
os.system("cp ../scripts/AnlAcceptance.py %s"%(outdatadir))
os.system("cp ../scripts/draw_2D.py %s"%(outdatadir))
...
runscript = "run_Doumeki_DEgg.py"

# create copyfiles
copyfiles = "run_Doumeki_DEgg.tgz"
