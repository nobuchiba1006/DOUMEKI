...
//
//
// $Id: J4PhysicsList.cc,v 1.2 2007/03/13 17:29:14 hoshina Exp $
// GEANT4 tag $Name:  $
//
...
J4PhysicsList::J4PhysicsList() :  G4VUserPhysicsList()
{
  ...
  theMieScatteringProcess = 0;
  theBoundaryProcess           = 0;
  
  pMessenger = new J4PhysicsListMessenger(this);  
  SetVerboseLevel(1);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

J4PhysicsList::~J4PhysicsList() { delete pMessenger;}
...
void J4PhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void J4PhysicsList::ConstructLeptons()
{
  // leptons
...
void J4PhysicsList::ConstructMesons()
{
 //  mesons
...
void J4PhysicsList::ConstructBaryons()
{
//  barions
...
void J4PhysicsList::ConstructOp()
{
  theCerenkovProcess           = new G4Cerenkov("Cerenkov");
  theScintillationProcess      = new G4Scintillation("Scintillation");
  theAbsorptionProcess         = new G4OpAbsorption();
  theRayleighScatteringProcess = new G4OpRayleigh();
  theMieScatteringProcess      = new G4OpMieHG();
...
void J4PhysicsList::SetVerbose(G4int verbose)
{
  ...
  theMieScatteringProcess->SetVerboseLevel(verbose);
  theBoundaryProcess->SetVerboseLevel(verbose);  
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void J4PhysicsList::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{  
