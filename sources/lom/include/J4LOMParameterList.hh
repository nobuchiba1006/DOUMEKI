// $Id: J4LOMParameterList.hh,v 1.1.1.1 2004/08/26 07:04:26 hoshina Exp $
#ifndef __J4LOMParameterList__hh
#define __J4LOMParameterList__hh
//********************************************************************
//* ---------------------
//* J4LOMParameterList.hh
//* ---------------------
//* (Description)
...
class J4LOMParameterList : public J4VParameterList 
{

 protected:  
   J4LOMParameterList(const G4String &name);   

 public:
   virtual ~J4LOMParameterList();  
   ...
   static J4LOMParameterList *GetInstance(); 
   ...
   PMTPlacement CalcPMTPlacement(G4int id);
 ...
 private:
   ...
   static J4LOMParameterList *fgInstance;
