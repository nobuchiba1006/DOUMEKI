// $Id: J43inchPMTCathodeSD.cc,v 1.2 2007/03/13 17:29:14 hoshina Exp $
//*************************************************************************
//* --------------------
//* J43inchPMTCathodeSD
//* --------------------
...
J43inchPMTCathodeSD::J43inchPMTCathodeSD(J4VDetectorComponent* detector)
...
J43inchPMTCathodeSD::~J43inchPMTCathodeSD()
{
}
...
void J43inchPMTCathodeSD::Initialize(G4HCofThisEvent* HCTE)
{
...
G4bool J43inchPMTCathodeSD::ProcessHits(G4Step* aStep, G4TouchableHistory* )
{

  std::cerr << "J43inchPMTCathodeSD::ProcessHits: called! " << G4endl;
  ...
  if ( preStepPoint->GetStepStatus() != fGeomBoundary) {
    std::cerr << "---------------------------------J43inchPMTCathodeSD::ProcessHits: the prestep point must on PMT surface. return " << G4endl; 
  ...
  J43inchPMTHit* hit = new J43inchPMTHit(GetComponent(), pre, ce, insideid, pmtid); 
  ...
  std::cerr << "J43inchPMTCathodeSD::ProcessHits:intersection = " << pre.x() << " " << pre.y() << " " << pre.z() << " " << MyName << G4endl;
...
void J43inchPMTCathodeSD::EndOfEvent(G4HCofThisEvent* )
{			
...
void J43inchPMTCathodeSD::DrawAll()
{
}
...
void J43inchPMTCathodeSD::PrintAll()
{
