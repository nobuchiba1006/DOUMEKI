// $Id: J44inchPMTCathode.hh,v 1.1.1.1 2004/08/26 07:04:26 hoshina Exp $
#ifndef __J44inchPMTCathode__hh
#define __J44inchPMTCathode__hh
//*************************************************************************
//* --------------------
//* J44inchPMTCathode
//* --------------------
...
class J44inchPMTCathode : public J4VDetectorComponent {	

public:

  J44inchPMTCathode(J4VDetectorComponent* parent    = 0,
           G4int                 nclones   = 1,
           G4int                 nbrothers = 1, 
           G4int                 me        = 0,
           G4int                 copyno    = -1);
  	     
  virtual ~J44inchPMTCathode();
