// $Id: Dominant_MEgg.cc,v 1.1.1.1 2017/08/29 lulu Exp $
// ====================================================================
//    Dominant_MEgg.cc
//   
//    MEgg Raytrace Monte-Carlo program
//
//    NOTE:
...
int main(int argc, char** argv) 
{
  ...
  J4MEggParameterList *deggparam = J4MEggParameterList::GetInstance(); 
  ...
  J4MEgg *dcptr = new J4MEgg();
  //J48inchPMT *dcptr = new J48inchPMT();
  //J4MEggGel *dcptr = new J4MEggGel();
